...
ToolRegistry.register('allocate_budget', allocate_budget)
...
ToolRegistry.register('approve_strategy', approve_strategy)
...
ToolRegistry.register('assign_technical_task', assign_technical_task)
...
ToolRegistry.register('evaluate_tech_debt', evaluate_tech_debt)
...
ToolRegistry.register('calculate_budget', calculate_budget)
...
ToolRegistry.register('audit_expense', audit_expense)
...
ToolRegistry.register('plan_sprint', plan_sprint)
...
ToolRegistry.register('track_progress', track_progress)
...
ToolRegistry.register('code_review', code_review)
...
ToolRegistry.register('estimate_effort', estimate_effort)
...
ToolRegistry.register('negotiate_contract', negotiate_contract)
...
ToolRegistry.register('generate_lead', generate_lead)
...
ToolRegistry.register('offer_pricing', offer_pricing)
...
ToolRegistry.register('adjust_terms', adjust_terms)
...
ToolRegistry.register('propose_service', propose_service)
...
ToolRegistry.register('renegotiate', renegotiate)
...
ToolRegistry.register('poach_customer', poach_customer)
...
ToolRegistry.register('price_war', price_war)
...
ToolRegistry.register('inspect_compliance', inspect_compliance)
...
ToolRegistry.register('impose_fine', impose_fine)
