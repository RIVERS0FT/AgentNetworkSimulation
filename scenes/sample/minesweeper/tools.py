...
def initialize_minesweeper_map_tool(**kwargs):
    """
    初始化 9x9 扫雷棋盘技能
    """
    _engine.init_map()
...
def move_and_reconnaissance_tool(**kwargs):
    """
...
def query_game_status_tool(**kwargs):
    """
...
# 注册技能
ToolRegistry.register("initialize_minesweeper_map_tool", initialize_minesweeper_map_tool)
ToolRegistry.register("move_and_reconnaissance_tool", move_and_reconnaissance_tool)
ToolRegistry.register("query_game_status_tool", query_game_status_tool)