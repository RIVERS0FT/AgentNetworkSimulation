...
def llm_code_generate_tool(**kwargs):
    """
...
ToolRegistry.register("llm_code_generate_tool", llm_code_generate_tool)


def llm_document_assist_tool(**kwargs):
...
ToolRegistry.register("llm_document_assist_tool", llm_document_assist_tool)


def llm_model_inference_tool(**kwargs):
...
ToolRegistry.register("llm_model_inference_tool", llm_model_inference_tool)


def llm_eda_simulation_tool(**kwargs):
...
ToolRegistry.register("llm_eda_simulation_tool", llm_eda_simulation_tool)
