...
# 通用：获取可谈判对象列表
# ============================================================
def list_candidates_tool(**kwargs):
    """
    列出所有可谈判的对方角色。
...
ToolRegistry.register("list_candidates_tool", list_candidates_tool)
...
ToolRegistry.register("evaluate_proposals_tool", evaluate_proposals_tool)
...
ToolRegistry.register("sign_contract_tool", sign_contract_tool)
...
ToolRegistry.register("terminate_contract_with_flash_tool", terminate_contract_with_flash_tool)
...
ToolRegistry.register("submit_bidding_proposal_tool", submit_bidding_proposal_tool)
...
ToolRegistry.register("process_breach_notification_tool", process_breach_notification_tool)
...
def broker_deal_tool(**kwargs):
    ...
    return result
ToolRegistry.register("broker_deal_tool", broker_deal_tool)
